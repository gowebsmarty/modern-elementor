...
use \ModernAddonsElementor\Widgets\Popcontent\MDEL_Popcontent_Handler as Handler;
 ...
 * @since 1.0.0
 */
class MDEL_Popcontent extends \Elementor\Widget_Base
{

  private $prefix = 'mdel_popcontent_';
  ...
  protected function _register_controls()
  {
    ...
    $this->add_responsive_control(
      ...
      [
        ...
        'description' => __('Choose an height that fills both front & back', 'modern-addons-elementor'),
        ...
        'selectors' => [
          '{{WRAPPER}} .mdel-popcontent' => 'min-height: {{SIZE}}{{UNIT}};',
        ],
      ]
    );
  ...
  protected function mdel_design_controls()
  {
    ...
    $this->add_responsive_control(
      ...
      [
        ...
        'size_units' => ['px'],
        'selectors' => [
          '{{WRAPPER}} .mdel-popcontent .mdel-pop-front' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ],
        'default' => [
          'top' => 20,
          'right' => 20,
    ...
    $this->add_group_control(
      ...
      [
        ...
        'selector' => '{{WRAPPER}} .mdel-popcontent .mdel-pop-front',
        'fields_options' => [
          'background' => [
            'default' => 'classic'
          ],
    ...
    $this->add_responsive_control(
      ...
      [
        ...
        'size_units' => ['px'],
        'selectors' => [
          '{{WRAPPER}} .mdel-popcontent .mdel-pop-back' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ],
        'default' => [
          'top' => 20,
          'right' => 20,
    ...
    $this->add_group_control(
      ...
      array_merge(
        [
          ...
          'label' => __('Background', 'modern-addons-elementor'),
          'types' => ['classic', 'gradient'],
          'selector' => '{{WRAPPER}} .mdel-popcontent .mdel-pop-back',
        ],
  ...
  protected function render()
  {
    ...
    $html = '<div class="mdel-popcontent">
    
<div class="mdel-pop-front' . $front_horizontal . '">';
    ...
    $html .= '</div>
<div class="mdel-pop-back' . $back_horizontal . '">';
